...
expenseButton.addEventListener("click", () => {
  if (checkDecimal(expenseInput.value)) {
    ...
    let concept = document.querySelector("#expense-amount-title").value;
...
const refreshBalance = () => {
  let budgetAmount = document.querySelector(".budget-amount").innerHTML;
...
const historyUpdate = (concept, amount) => {
  let conceptElement = document.createElement("div");
